...
#SBATCH --output=slurm_logs/traffic-nips-%j.out
#SBATCH --error=slurm_logs/traffic-nips-%j.err
...
# Traffic Quick Script for Optimized DPVAE
...
dataset="traffic"
root_path="./temp/datasets/traffic"
