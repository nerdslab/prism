...
#SBATCH --job-name=exchange_quick
#SBATCH --nodes=1
#SBATCH --gpus=2
...
#SBATCH --output=slurm_logs/exchange-nips-%j.out
#SBATCH --error=slurm_logs/exchange-nips-%j.err
...
dataset="exchange"
root_path="./temp/datasets/exchange_rate"
